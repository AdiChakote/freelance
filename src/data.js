...
export const gigs = [
  ...
  },
  {
    ...
    img: "/img/sample.jpg", // Adjust path if needed
    pp: "https://images.pexels.com/photos/720598/pexels-photo-720598.jpeg?auto=compress&cs=tinysrgb&w=1600", // Replace or keep
    desc: "Professional logo design service",
    price: 500,
    star: 5,
    username: "Aditya Chakote", // You can put any name
    cat: "design",
    userId: "12345", // Must match a valid user ID in your backend (MongoDB)
    shortTitle: "Logo",
    shortDesc: "Logo designing",
    totalStars: 20,
    starNumber: 4,
  },
];
